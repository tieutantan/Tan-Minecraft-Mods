...
@EventBusSubscriber(value = Dist.CLIENT, modid = AutoDeleteItems.MODID)
public class AutoDeleteItemsClient {

    private static final net.minecraft.client.KeyMapping OPEN_CONFIG = new net.minecraft.client.KeyMapping(
            "key.autodeleteitems.config",
            GLFW.GLFW_KEY_O,
    ...
    public static class ClientEvents {
        ...
        public static void onKeyInput(InputEvent.Key event) {
            if (event.getAction() == GLFW.GLFW_PRESS && OPEN_CONFIG.isDown()) {
                ...
                mc.setScreen(new AutoDeleteConfigScreen());
            }
        }
    }
}
