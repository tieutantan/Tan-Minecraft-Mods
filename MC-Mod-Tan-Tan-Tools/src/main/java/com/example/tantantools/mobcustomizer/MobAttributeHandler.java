...
// EntityAttributeModificationEvent implements IModBusEvent, so @EventBusSubscriber
// automatically registers this on the mod event bus instead of the NeoForge global bus.
@EventBusSubscriber(modid = TanTanTools.MODID)
public class MobAttributeHandler {
    ...
    public static void modifyMobAttributes(EntityAttributeModificationEvent event) {
        ...
        TanTanTools.LOGGER.info("Base mob attributes registered (vanilla defaults)");
    }
}
