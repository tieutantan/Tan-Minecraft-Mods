...
public final class MobConfigs {
    ...
    /**
        * A registered mob type with its spawn controls and attribute applier.
     */
    public record MobDef(
            Class<?> entityClass,
            ModConfigSpec.BooleanValue allowSpawn,
            ModConfigSpec.IntValue spawnRatePercent,
            ModConfigSpec.IntValue spawnSpeedPercent,
    ...
    private static final MobDef[] ALL = {
        new MobDef(Zombie.class,   MobCustomizerConfig.ALLOW_ZOMBIE_SPAWN,   MobCustomizerConfig.ZOMBIE_SPAWN_RATE_PERCENT,   MobCustomizerConfig.ZOMBIE_SPAWN_SPEED_PERCENT,   MobConfigs::applyZombie),
        new MobDef(Creeper.class,  MobCustomizerConfig.ALLOW_CREEPER_SPAWN,  MobCustomizerConfig.CREEPER_SPAWN_RATE_PERCENT,  MobCustomizerConfig.CREEPER_SPAWN_SPEED_PERCENT,  MobConfigs::applyCreeper),
        new MobDef(Skeleton.class, MobCustomizerConfig.ALLOW_SKELETON_SPAWN, MobCustomizerConfig.SKELETON_SPAWN_RATE_PERCENT, MobCustomizerConfig.SKELETON_SPAWN_SPEED_PERCENT, MobConfigs::applySkeleton),
        new MobDef(Spider.class,   MobCustomizerConfig.ALLOW_SPIDER_SPAWN,   MobCustomizerConfig.SPIDER_SPAWN_RATE_PERCENT,   MobCustomizerConfig.SPIDER_SPAWN_SPEED_PERCENT,   MobConfigs::applySpider),
        new MobDef(EnderMan.class, MobCustomizerConfig.ALLOW_ENDERMAN_SPAWN, MobCustomizerConfig.ENDERMAN_SPAWN_RATE_PERCENT, MobCustomizerConfig.ENDERMAN_SPAWN_SPEED_PERCENT, MobConfigs::applyEnderman),
        new MobDef(Witch.class,    MobCustomizerConfig.ALLOW_WITCH_SPAWN,    MobCustomizerConfig.WITCH_SPAWN_RATE_PERCENT,    MobCustomizerConfig.WITCH_SPAWN_SPEED_PERCENT,    MobConfigs::applyWitch),
        new MobDef(Slime.class,    MobCustomizerConfig.ALLOW_SLIME_SPAWN,    MobCustomizerConfig.SLIME_SPAWN_RATE_PERCENT,    MobCustomizerConfig.SLIME_SPAWN_SPEED_PERCENT,    MobConfigs::applySlime),
    };
